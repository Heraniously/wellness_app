...
urlpatterns = [
    ...
    path('finalize-booking/<int:class_id>/', views.finalize_booking, name='finalize_booking'),
    ...
    path('instructor/create-class/', views.create_class, name='create_class'),  # Added this for your teachers

    # Booking Management
    path('cancel/<int:booking_id>/', views.cancel_booking, name='cancel_booking'),
    path('toggle-payment/<int:booking_id>/', views.toggle_payment_status, name='toggle_payment_status'),
]